...
if __name__=='__main__':
    ...
    parser.add_argument('--checkpoint_path', type=str, default="/data3/gaoyuming/Task_Oriented_Grasping/LASO-main/runs/train/PointRefer/best_model-try_at_5.8_10.58.19.pt", help='checkpoint path')
